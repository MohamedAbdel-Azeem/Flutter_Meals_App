...
class CategoriesScreen extends StatelessWidget {
  ...
  void _selectCategory(BuildContext context , Category category){
    List<Meal> filteredMeals =  availableMeals.where((meal) => meal.categories.contains(category.id)).toList();
    ...
    return GridView(
        ...
        children: [
          for (final category in availableCategories)
            CategoryGridItem(category: category , navigate:() => _selectCategory(context,category)),
        ],
      );
  }
}
